    ...
    init: function(selector, onSaveCallback) {
      ...
      if (typeof tinyMCE !== 'undefined') {
        ...
        tinyMCE.init({
          ...
          toolbar: 'undo redo restoredraft | insert | styleselect | bold italic | alignleft aligncenter alignright alignjustify | table | bullist numlist outdent indent | link | forecolor backcolor | customimageuploader marvinjsplugin | codesample',
          plugins: plugins,
